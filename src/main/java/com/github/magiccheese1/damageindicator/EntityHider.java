...
public class EntityHider implements Listener {
  ...
  private static final PacketType[] ENTITY_PACKETS = { ENTITY_EQUIPMENT, NAMED_ENTITY_SPAWN, SPAWN_ENTITY,
      SPAWN_ENTITY_LIVING, ENTITY_VELOCITY, REL_ENTITY_MOVE, ENTITY_TELEPORT, ENTITY_STATUS, ATTACH_ENTITY,
      ENTITY_METADATA, ENTITY_EFFECT, REMOVE_ENTITY_EFFECT
